const Button = ({type, text, classes = '', textClasses = '', isDisabled, onClick}) => {
	let typeClasses = "";
	if (type === "primary") {
		typeClasses = "bg-[#000E55] text-white hover:bg-[#E667A4] transition-colors";
	} else if (type === "secondary") {
		typeClasses = "bg-white text-[#000E55] border border-[#000E55] hover:bg-[#E667A4] hover:text-white transition-colors";
	}
	return (
		<div
			onClick={onClick}
