export const transliterate = (str, reverse = false) => {
	const chars = {
		а: "a",
		б: "b",
		в: "v",
...
// console.log(transliterate("Привіт Вася")); // => "pryvit vasia"
// console.log(transliterate("pryvit vasia", true)); // => "привіт вася"
// console.log(transliterate("shchastia", true)); // => "щастя"
