...
const SocialMediaList = () => {
	const items = [
		...
		{icon: 'viber', title: 'ДРОП', link: 'https://invite.viber.com/?g2=AQBbJ%2BXb2uClMFSC6vure1IGuhLvlb144kglbXjoA0lex1DPoo79HdiJ5Ef6o0No', src: require(`../../../assets/icons/viber.svg`).default},
	];
